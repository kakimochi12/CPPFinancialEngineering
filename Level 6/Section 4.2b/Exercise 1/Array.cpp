...
template <typename T>                 // initializing static in source file
int Array<T>::defaultsize = 10;


// default constructor
// initializes array with static variable amount defaultsize * T object using the default constructor
template <typename T>
Array<T>::Array() : m_size(defaultsize), m_data(new T[defaultsize])
{
...
// static getter for the static default size
template <typename T>
...
// static setter for the static default size
template <typename T>
