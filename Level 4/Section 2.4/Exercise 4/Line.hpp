...
public:
    ...
    // ostream operator allows for sending a line directly to the cout object without calling ToString method
    // Friend so that it remains global AND it can access datamembers directly
