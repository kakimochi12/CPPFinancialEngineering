...
public:
    ...
    explicit Point(double x);                   // This is the constructor that takes one double as an argument MADE EXPLICIT to avoid implicit use
    ~Point();                          // Destructor
    ...
    // Friend so that it can remain a global function AND access data members of class
